...
const blocks = {
    ...
    'teaser': {
        ...
        'output': i => `<table width="100%">
            <tr>
                <td style="border: 1px solid black">Teaser</td>
            </tr>
            <tr>
    ...
    'product-carousel': {
        ...
        'output': items => `<table width="100%">
            <tr>
                <td style="border: 1px solid black">Carousel (Product)</td>
            </tr>
            <tr>
    ...
    'category-carousel': {
        ...
        'output': items => `<table width="100%">
            <tr>
                <td style="border: 1px solid black">Carousel (Category)</td>
            </tr>
            <tr>
                <td style="border: 1px solid black">
                    <ul>
                        ${items.map(i => `<li>${i.uid}</li>`).join('')}
                    </ul>
                </td>
            </tr>
        </table>`,
